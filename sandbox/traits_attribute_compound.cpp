...
int main()
{
    ...
    static_assert(glt::is_compound_seq_v<glt::compound<glm::vec3, glm::vec2>>);
    static_assert(!glt::is_compound_seq_v<glt::compound<glm::vec3>>);
    static_assert(!glt::is_compound_seq_v<glt::compound<>>);
    static_assert(!glt::is_compound_seq_v<glm::vec3>);

    // named attributes
    static_assert(glt::is_compound_seq_v<glt::compound<glt::glslt<glm::vec3, xyz>, glt::glslt<glm::vec2, xyz>>>);
    static_assert(!glt::is_compound_seq_v<glt::compound<glt::glslt<glm::vec3, xyz>>>);
    static_assert(!glt::is_compound_seq_v<glt::compound<>>);
