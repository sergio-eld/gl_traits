 ...
 *
 *  Requesting a valid_ but unavailable OpenGL or OpenGL ES version will instead
 ...
 *  should not free it yourself.  It is guaranteed to be valid_ only until the
 ...
 *  error, it is not guaranteed to be valid_ after the callback has returned.  If
 ...
 *
 *  @pointer_lifetime The returned string is allocated and freed by GLFW.  You
 *  should not free it yourself.  It is valid_ until the specified monitor is
 ...
 *  freed by GLFW.  You should not free them yourself.  They are valid_ until the
 ...
 *
 *  This function does not check whether the specified hint values are valid_.
 ...
 *
 *  @remark Zero is a valid_ value for many window and context related
 *  attributes so you cannot use a return value of zero as an indication of
 *  errors.  However, this function should not fail as long as it is passed
 *  valid_ arguments and the library has been [initialized](@ref intro_init).
 *
 *  @thread_safety This function must only be called from the main thread.
 *
 ...
 *
 *  @pointer_lifetime The returned string is allocated and freed by GLFW.  You
 *  should not free it yourself.  It is valid_ until the next call to @ref
 ...
 *  not a valid_ key for this function.
 ...
 *  for that event, they are not guaranteed to be valid_ after the callback has
 ...
 *
 *  @pointer_lifetime The returned array is allocated and freed by GLFW.  You
 *  should not free it yourself.  It is valid_ until the specified joystick is
 *  disconnected or the library is terminated.
 *
 *  @thread_safety This function must only be called from the main thread.
 *
 ...
 *  string.
 *
 *  @param[in] window Deprecated.  Any valid_ window or `NULL`.
 ...
 *
 *  @pointer_lifetime The returned function pointer is valid_ until the context
 ...
 *  GLFW_API_UNAVAILABLE.
 *
 *  @pointer_lifetime The returned function pointer is valid_ until the library
 *  is terminated.
 *
 *  @thread_safety This function may be called from any thread.
 *
